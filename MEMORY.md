...
| 2.6 실제 카메라(192.168.0.217) 단일 스트림 수동 테스트 | 🔄 진행 중 | 진단 도구 준비 완료 (cmd/streamtest, commit 5cd4156). 사용자 실행 대기 |
...
| 2026-08-31 02:00 | Phase 3 진행 지시 + **.skills/frontend-design 스킬 반드시 적용** 지시 | Phase 3 프론트엔드 작업 시작 |
