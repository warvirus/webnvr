...
type Client struct {
	...
	// webnvr patch: allow the remote SSRC to change mid-session instead of
	// failing with "received packet with wrong SSRC". Useful with servers
	// that restart their encoder (and change SSRC) when a new client connects.
